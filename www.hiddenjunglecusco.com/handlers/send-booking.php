<?php
/**
 * Booking Enquiry Handler – Hidden Jungle Cusco
...
$body  = "NEW BOOKING ENQUIRY – Hidden Jungle Cusco\n";
$body .= str_repeat('=', 50) . "\n\n";
...
$body .= "\nAdditional Notes:\n$notes\n\n";
$body .= str_repeat('-', 50) . "\n";
$body .= "Sent via hiddenjunglecusco.com booking form.\n";
...
if ($sent) {
    ...
    $arBody  = "Hello $tname,\n\n";
    $arBody .= "Thank you for your booking enquiry with Hidden Jungle Cusco!\n\n";
    ...
    $arBody .= "Best regards,\nHidden Jungle Cusco\n";
    $arBody .= "discover@hiddenjunglecusco.com\n";
    ...
    echo json_encode(['ok'=>false,'message'=>'We could not process your request right now. Please contact us directly at discover@hiddenjunglecusco.com or via WhatsApp.']);
}
