...
<header id="N"><div class="cx ni">
  ...
  <nav class="nm" aria-label="Main navigation">
    ...
    <button class="lang-toggle" onclick="document.cookie.indexOf('googtrans=/en/es')!==-1 ? doTranslate('en') : doTranslate('es')" translate="no">
      <script>
...
<section class="hero" style="background: url('assets/img/hero.png') no-repeat center center/cover;">
  ...
  <div class="cx hb">
    ...
    <div class="ha">
      <a href="contact/index.html" class="btn ba" ><i class="fas fa-compass"></i> Book a Tour</a>
...
<section class="cs" id="plan-trip">
  ...
  <div class="cb rr">
    ...
    <div class="cba">
      <a href="contact/index.html" class="btn bd" ><i class="fas fa-compass"></i> Book a Tour</a>
