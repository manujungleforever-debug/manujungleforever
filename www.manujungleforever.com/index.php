...
<meta property="og:description" content="Guided tours from Cusco to the Manu National Park in the Peruvian Amazon. Local, wild, and authentic.">
<meta property="og:image" content="<?php echo htmlspecialchars(SITE_URL); ?>/assets/img/hero.png">
...
<link rel="icon" href="assets/img/hero.png" sizes="32x32">
<link rel="apple-touch-icon" href="assets/img/hero.png">
...
<script type="application/ld+json">{"@context":"https://schema.org","@type":"TouristAttraction","name":"<?php echo htmlspecialchars(SITE_NAME); ?>","url":"<?php echo htmlspecialchars(SITE_URL); ?>/","description":"Guided tours from Cusco to the Manu National Park in the Peruvian Amazon.","telephone":"+51979808013","email":"<?php echo htmlspecialchars(SITE_EMAIL); ?>","address":{"@type":"PostalAddress","addressLocality":"Nuevo Eden","addressCountry":"PE"},"sameAs":["https://www.facebook.com/manujungleforever","https://www.instagram.com/manujungleforever/","https://www.tripadvisor.com/Attraction_Review-g294314-d17476586-Reviews-Hidden_Jungle_Cusco-Cusco_Cusco_Region.html"]}</script>
...
<section class="sp" id="unique-content" style="background:var(--k); border-top:1px solid rgba(255,255,255,.05)">
  <div class="spi rl">
    <img src="wp-content/uploads/2022/10/Hero-About-Us.jpg" alt="Manu Jungle Forever Family and Guides" loading="lazy">
  </div>
...
<section class="sec" style="background:var(--f)" id="reviews">
  <div class="cx">
    <div class="r" style="text-align:center;margin-bottom:48px"><span class="ey">Traveler Stories</span><h2 class="h2">Traveler Testimonials</h2></div>
    <div class="rv-w r">
...
<section class="sec" style="background:var(--k)" id="location">
  <div class="cx">
    ...
    <div class="mp r"><iframe src="<?php echo htmlspecialchars(GOOGLE_MAP); ?>" title="Manu Jungle Forever route map" loading="lazy" allowfullscreen></iframe></div>
  </div>
</section>
...
<a href="https://api.whatsapp.com/send?phone=<?php echo htmlspecialchars(WHATSAPP_NUMBER); ?>&text=Hello!%20I%20would%20like%20to%20learn%20more%20about%20your%20jungle%20trips" class="wa" target="_blank" rel="noopener" aria-label="Chat on WhatsApp" id="whats-flotante"><i class="fa-brands fa-whatsapp"></i></a>
