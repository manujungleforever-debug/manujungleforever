...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `reclamos_codigo_reclamo_unique` ON `reclamos` (`codigo_reclamo`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS `tours_slug_unique` ON `tours` (`slug`);--> statement-breakpoint
