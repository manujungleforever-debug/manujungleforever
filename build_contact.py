...
<section class="in-hero" style="background-image: url('{REL}wp-content/uploads/2018/02/HiddenJungleCusco_Sliders2.jpg');">
  <div class="cx">
    ...
    <p class="hs" style="margin:0 auto">We'd love to hear from you. Plan your jungle adventure today.</p>
  </div>
</section>
...
<section class="sec" style="background:var(--k)">
  <div class="cx">
    ...
    <div class="contact-grid">
      ...
      <div class="r">
        <div class="contact-info-card">
          <span class="ey">Reach Out</span>
          <h2 class="h2" style="margin-bottom:32px; font-size:1.8rem">Contact Information</h2>
          ...
          <div class="contact-info-item">
            ...
            <div>
              ...
              <div class="ci-val">
                <a href="tel:+51979808013">+51 979 808 013</a><br>
                <a href="https://api.whatsapp.com/send?phone=51923289231&text=Hello!%20I%20would%20like%20to%20learn%20more%20about%20your%20jungle%20trips" target="_blank" rel="noopener">+51 923 289 231 (Anna's WhatsApp)</a>
              </div>
            </div>
          </div>
          ...
          <div class="contact-info-item">
            ...
            <div>
              ...
              <div class="ci-val"><a href="mailto:discover@hiddenjunglecusco.com">discover@hiddenjunglecusco.com</a></div>
            </div>
          </div>
          ...
          <div class="contact-info-item">
            ...
            <div>
              ...
              <div class="ci-val">
                <a href="https://goo.gl/maps/B8NjhLZizA6YKwKD6" target="_blank" rel="noopener">
                  Hidden Jungle Cusco – La Casa Escondida 17800<br>Nuevo Eden, Peru
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="contact-info-item">
            ...
            <div>
              ...
              <div class="ci-val">We typically reply within 24 hours</div>
            </div>
          </div>

          <div class="social-row">
            <a href="https://www.facebook.com/hiddenjunglecusco" class="soc-btn" target="_blank" rel="noopener" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
            <a href="https://www.instagram.com/hiddenjunglecusco/?hl=en" class="soc-btn" target="_blank" rel="noopener" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
            <a href="https://www.tripadvisor.com/Attraction_Review-g294314-d17476586-Reviews-Hidden_Jungle_Cusco-Cusco_Cusco_Region.html" class="soc-btn" target="_blank" rel="noopener" aria-label="TripAdvisor"><i class="fab fa-tripadvisor"></i></a>
            <a href="https://abnb.me/Ri8XQWoA19" class="soc-btn" target="_blank" rel="noopener" aria-label="Airbnb"><i class="fab fa-airbnb"></i></a>
            <a href="https://wa.me/51923289231" class="soc-btn" target="_blank" rel="noopener" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a>
            <a href="https://www.tiktok.com/@hidden.jungle.cus" class="soc-btn" target="_blank" rel="noopener" aria-label="TikTok"><i class="fab fa-tiktok"></i></a>
          </div>
        </div>
        ...
        <div class="map-container">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3754.123!2d-71.3234!3d-12.8654!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x916e5a1b1b1b1b1b%3A0x1b1b1b1b1b1b1b1b!2sHidden+Jungle+Cusco!5e0!3m2!1sen!2spe!4v1600000000000!5m2!1sen!2spe"
            loading="lazy"
            referrerpolicy="no-referrer-when-downgrade"
            title="Hidden Jungle Cusco location map"
            allowfullscreen>
          </iframe>
        </div>
      </div>
      ...
      <div class="r">
        <div class="form-card">
          <span class="ey">Plan Your Jungle Trip</span>
          <h2 class="h2" style="margin-bottom:8px; font-size:1.8rem">Send Us a Message</h2>
          <p style="color:rgba(255,255,255,.5); font-size:.9rem; margin-bottom:32px;">Fill in the form below and we'll get back to you as soon as possible to help plan your adventure.</p>

          <div class="form-msg" id="contact-msg"></div>

          <form id="contact-form" onsubmit="submitContact(event)" novalidate>
            <div class="form-row">
              <label for="c-name">Full Name <span class="form-req">*</span></label>
              <input type="text" id="c-name" name="name" required placeholder="e.g. John Doe">
            </div>
            <div class="form-2col">
              <div class="form-row">
                <label for="c-email">Email Address <span class="form-req">*</span></label>
                <input type="email" id="c-email" name="email" required placeholder="john@example.com">
              </div>
              <div class="form-row">
                <label for="c-phone">Phone / WhatsApp</label>
                <input type="tel" id="c-phone" name="phone" placeholder="+1 555-0199">
              </div>
            </div>
            <div class="form-2col">
              <div class="form-row">
                <label for="c-date">Preferred Travel Date</label>
                <input type="date" id="c-date" name="date">
              </div>
              <div class="form-row">
                <label for="c-guests">Number of Guests</label>
                <input type="number" id="c-guests" name="guests" min="1" max="20" placeholder="e.g. 2">
              </div>
            </div>
            <div class="form-row">
              <label for="c-tour">Tour of Interest</label>
              <select id="c-tour" name="tour">
                <option value="">— Select a tour (optional) —</option>
                <option>3-Day Jungle Wildlife Quest – Machu Wasi</option>
                <option>4-Day Jungle Wildlife Quest – Machu Wasi</option>
                <option>4-Day Jungle Wildlife Quest – Nuevo Eden</option>
                <option>5-Day Jungle Wildlife Quest – Nuevo Eden</option>
                <option>6-Day Jungle Wildlife Quest – Blanquillo</option>
                <option>6-Day Manu Reserved Zone</option>
                <option>8-Day Wildlife Photography Tour</option>
                <option>5-Day Amazon Expedition</option>
                <option>6-Day Amazon Expedition</option>
                <option>Rainforest Road Trip</option>
                <option>Not sure yet – help me choose!</option>
              </select>
            </div>
            <div class="form-row">
              <label for="c-msg">Your Message <span class="form-req">*</span></label>
              <textarea id="c-msg" name="message" required placeholder="Tell us about your dream jungle experience, any questions you have, dietary needs, etc."></textarea>
            </div>
            <button type="submit" class="btn ba" id="contact-submit" style="width:100%; justify-content:center; font-size:1rem; padding:16px;">
    ...
    <!-- WhatsApp CTA bar -->
    <div class="wa-cta-bar r">
      <div class="wa-cta-text">
        <h3><i class="fab fa-whatsapp" style="color:#25d366; margin-right:10px;"></i>Prefer to chat directly?</h3>
        <p>Message Anna on WhatsApp for instant answers about tours, dates and availability.</p>
      </div>
      <a href="https://api.whatsapp.com/send?phone=51923289231&text=Hello!%20I%20would%20like%20to%20learn%20more%20about%20your%20jungle%20trips" target="_blank" rel="noopener" class="btn-wa">
